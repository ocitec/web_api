...
travelpackages_collection = database["travelpackages"]
reservations_collection = database["package_reservations"]
categories_collection = database["package_categories"]
